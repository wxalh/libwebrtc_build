...
export WEBRTC_OUT_DIR="${WEBRTC_OUT_DIR:-Linux_x64_m144_${WEBRTC_LINUX_STL}_${WEBRTC_BUILD_CONFIG}}"
export WEBRTC_PACKAGE_DIR="${WEBRTC_PACKAGE_DIR:-}"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
exec "$SCRIPT_DIR/../../_shared/clean_linux.sh" "$@"
